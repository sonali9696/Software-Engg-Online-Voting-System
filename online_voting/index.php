...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/background1.jpg');">
  <section id="testimonials" class="hoc container clear"> 
    <!-- ################################################################################################ -->
    <h2 class="font-x3 uppercase btmspace-80 underlined"> Welcome:<a href="#"> Swag se Karenge Sabko Vote</a></h2>
    <blockquote>
	<ul class="nospace group">
      <li class="one_half">
        This is an online voting system which can be used by candidate, voter, organization or admin to facilitate elections, right from the comfort of your home, which are presently conducted by Election Commission Of India (ECI). 
		</li>
    </ul>
	 </blockquote>
    <!-- ################################################################################################ -->
