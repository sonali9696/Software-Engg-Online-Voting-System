  ...
  <header id="header" class="hoc clear"> 
    ...
    <nav id="mainav" class="fl_right">
      <ul class="clear">
		...
		<li class="active"><a href="http://localhost/online_voting/index.php">Welcome Page</a></li>
      </ul>
    </nav>
    <!-- ################################################################################################ -->
  </header>
...
<center>      
Want to go back?  <a href="http://localhost/online_voting/index.php"><b>Click Here</b></a> to return to Welcome Page
<br>
</center>
</form>
</tr>
